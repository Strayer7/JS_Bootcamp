...
class App {
    ...
    run() {
        ...
        let whichOpponentDecision = prompt("Выбери оппонента: 0 человек, 1 - ИИ");
		if (whichOpponentDecision === 0)
		{
			this._secondPlayer = new Player("Alex", this.boardSize);
        ...
        {
            this._secondPlayer = new AIPlayer ("AI", this.boardSize)
            this.shipArrangement(this._firstPlayer, this._maxShipCount, this._shipMaxLength)
            this._secondPlayer.placeShip(this._maxShipCount, this._shipMaxLength)
        }
...
class AIPlayer extends Player {
    ...
    placeShip(maxShipCount, maxShipLength) {
